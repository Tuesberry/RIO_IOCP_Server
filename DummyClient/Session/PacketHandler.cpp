...
/* --------------------------------------------------------
*	Method:		PacketHandler::HandlePacket
*	Summary:	handle packet
*	Args:		shared_ptr<ClientSession> session
*					owner of packet
*				char* buffer
*					char that transfered from server
*				int len
*					buffer size
-------------------------------------------------------- */
bool PacketHandler::HandlePacket(shared_ptr<ClientSession> session, char* buffer, int len)
{
...
/* --------------------------------------------------------
*	Method:		PacketHandler::Handle_S2C_MOVE_RESULT
...
*					buffer size
-------------------------------------------------------- */
bool PacketHandler::Handle_SC2_MOVE_RESULT(shared_ptr<ClientSession> session, char* buffer, int len)
{
	PacketHeader header = *(reinterpret_cast<PacketHeader*>(buffer));
...
/* --------------------------------------------------------
*	Method:		PacketHandler::Handle_S2C_MOVE
...
*					buffer size
-------------------------------------------------------- */
bool PacketHandler::Handle_S2C_MOVE(shared_ptr<ClientSession> session, char* buffer, int len)
{
	return true;
}

/* --------------------------------------------------------
*	Method:		PacketHandler::Handle_S2C_ENTER
...
*					buffer size
-------------------------------------------------------- */
bool PacketHandler::Handle_S2C_ENTER(shared_ptr<ClientSession> session, char* buffer, int len)
{
	return true;
}

/* --------------------------------------------------------
*	Method:		PacketHandler::Handle_S2C_LEAVE
...
*					buffer size
-------------------------------------------------------- */
bool PacketHandler::Handle_S2C_LEAVE(shared_ptr<ClientSession> session, char* buffer, int len)
{
	return true;
}

/* --------------------------------------------------------
*	Method:		PacketHandler::Handle_LOGIN_RESULT
...
*					buffer size
-------------------------------------------------------- */
bool PacketHandler::Handle_LOGIN_RESULT(shared_ptr<ClientSession> session, char* buffer, int len)
{
	PacketHeader header = *(reinterpret_cast<PacketHeader*>(buffer));
...
shared_ptr<NetBuffer> PacketHandler::CreateNetBuffer(Protocol::C2S_LOGIN& pkt)
{
	return _CreateNetBuffer(pkt, PROTO_ID::C2S_LOGIN);
}

shared_ptr<NetBuffer> PacketHandler::CreateNetBuffer(Protocol::C2S_MOVE& pkt)
{
	return _CreateNetBuffer(pkt, PROTO_ID::C2S_MOVE);
}
